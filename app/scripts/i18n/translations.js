Ember.I18n.translations = {
  ...
  "conversations.addPhotos": "Add Moments to Group",
  "conversations.addAlbum": "Add Album to Group",
  "conversation.members.one": "{{count}} Person",
  "conversation.members.other": "{{count}} People",
  'post.prompt': 'Add a note ...',
  'comments.prompt': 'Reply...',
  'post.likes.one': '{{count}} Like',
  'post.likes.other': '{{count}} Likes',
  'post.doPost': 'Post',
  'post.addAlbum': 'Add Album',
  'post.addPhotos': 'Add Moments',
  ...
  'photos.createdAlbum.one': 'Created album "{{albumName}}" with {{count}} photo',
  'photos.createdAlbum.other': 'Created album "{{albumName}}" with {{count}} photos',
  ...
  'share.linkGenerateFailed': 'We weren\'t able to generate a share link.',
  ...
  'search.inputTooShort.one': 'Please type {{count}} more character.',
  'search.inputTooShort.other': 'Please type {{count}} more characters.',
};